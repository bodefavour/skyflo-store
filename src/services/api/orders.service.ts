...
const mapOrder = (item: RawOrder): Order => ({
    ...
    subtotal: item.subtotal !== undefined && item.subtotal !== null ? Number(item.subtotal) : undefined,
    shipping_fee: item.shipping_fee !== undefined && item.shipping_fee !== null ? Number(item.shipping_fee) : undefined,
    tax: item.tax !== undefined && item.tax !== null ? Number(item.tax) : undefined,
    notes: item.notes ?? undefined,
    currency_code: item.currency_code ?? undefined,
    currency_rate: item.currency_rate !== undefined && item.currency_rate !== null ? Number(item.currency_rate) : undefined,
