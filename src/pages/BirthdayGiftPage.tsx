...
return (
    <main>
      <NavBar />
      <HeroSection backgroundImage="/images/hero-bg.jpg" brandName="Birthday"  textSize="text-xs md:text-sm lg:text-base" customStyle={{ fontSize: "1rem" }} /> // Adjust this value as needed
